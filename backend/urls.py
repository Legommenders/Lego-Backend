...
from evaluation.views import EvaluationView, ExperimentView, ExperimentRegisterView, LogView, LogAnalyseView
...
urlpatterns = [
    ...
    path('log-analyse', LogAnalyseView.as_view(), name='log-analyse'),
